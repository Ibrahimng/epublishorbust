  ...
  <div class="date-nav item-list">
    <ul class="pager">
      <?php if (!empty($prev_url)) : ?>
        <li class="date-prev">
          <?php
          $text = '<span class="element-invisible">&laquo;';
      ...
      <?php if (!empty($next_url)) : ?>
        <li class="date-next">
          <?php
          $text = '<span class="element-invisible">&raquo;';
          $text .= $mini ? '' : ' ' . t('Next', array(), array('context' => 'date_nav'));
          $text .= '</span>';
          print l(t($text), $next_url, $next_options);
          ?>
        </li>
      <?php endif; ?>
    </ul>
